		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Custom control 101",
									"targetURL": "#comsmoduxcustomcontrol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsmoduxcustomcontrol-display": {
								"semanticObject": "comsmoduxcustomcontrol",
								"action": "display",
								"description": "Custom control training",
								"title": "Custom control 101",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.smod.ux.customcontrol",
									"url": sap.ui.require.toUrl("com/smod/ux/customcontrol")
								}
							}
						}
					}
